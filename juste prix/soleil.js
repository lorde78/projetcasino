...
function Partie1_2(){
    ...
    document.getElementById("AfficherConsigne").style.display = "none" ;
...
function Partie2_2(){
    ...
    document.getElementById("AfficherConsigne").innerHTML = "Dis à Robot si c'est plus ou moins que ton nombre";
